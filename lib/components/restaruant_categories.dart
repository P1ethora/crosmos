...
import '../model/menuBar.dart';

class ResuaranCategories extends SliverPersistentHeaderDelegate {
  final ValueChanged<int> onChanged;
  final int selectedIndex;

  ResuaranCategories({required this.onChanged, required this.selectedIndex});
